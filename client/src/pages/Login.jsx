...
const Login = () => {
  ...
  return (
    <div className='flrx items-center justify-center min-h-screen px-6 sm:px-0 bg-gradient-to-br from-blue-200 to-purple-400'>
        <img src={assets.logo} alt="" className='absolute left-5 sm:left-20 top-5 w-28 sm:w-32 cursor-pointer' />

        <div className='bg-slate-900 p-10 rounded-lg shadow-lg w-full sm:w-96 text-indigo-300 text-sm  '>
          <h2 className='text-3xl font-semibold terxt-white text-center mb-3'>{state == "signup" ? "Create account." : "Login "}</h2>
          <p className='text-center text-sm mb-6 '>{state == "signup" ? "Create your account." : "Login to your acoount."}</p>
